...
//import models
const { Candidate, Role, Employer, Offer, CategoryJob, Login } = require('./schema');
...
(async()=>{
    ...
    const yves = await Candidate.create({
        ...
        profilImg : "Bhttps://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_6FS-PjJwSzN6nGbSJng09kxlB55K3-TGBQ&usqp=CAU",
        nationality :"Belge",
    ...
    const emp1 = await Employer.create({
        ...
        phone: "045236541",
        fax: "02351654",
        profilImg: "https://gem.ec-nantes.fr/wp-content/uploads/2019/01/profil-vide.png",
        tva: "BE3236521458",
